                                ...
                                <tr>
                                    <form method="get">
                                        ...
                                        <td class="text-end">
                                            ...
                                            <a class="btn btn-success btn-sm" href="./baby.php?delete&id=<?= $content['id'] ?>" role="button">Delete</a>
                                        </td>
                                    </form>
                                </tr>
                            <?php endforeach; ?>
